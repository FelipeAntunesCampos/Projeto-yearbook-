...
const dadosFuncionarios = [
  {
    ...
    email: "helena.ribeiro@brightmindsacademy.com.br",
  ...
  {
    nome: "Carlos Silva",
    email: "carlos.silva@brightmindsacademy.com.br",
    cargo: "Professor de Matemática",
    registro: "2025MWXG",
    biografia: "Mostrando que os números podem ser divertidos e estão em toda parte. Há 10 anos na escola."
  },
  {
  ...
  {
    nome: "Fernanda Lima",
    email: "fernanda.lima@brightmindsacademy.com.br",
    cargo: "Professora de Ciências (Fundamental II)",
    registro: "2025FPLC",
...
async function main() {
  ...
  // ===============================================
  // 1. SEEDING DE FUNCIONÁRIOS E FOTOS
  // ===============================================
  console.log("Iniciando Seeding de Funcionários...");

  // 1.1. URLs de Funcionários
...
const resultFuncionarios = await prisma.funcionarios.createMany({
  ...
  // 1.3. BUSCAR IDs DOS FUNCIONÁRIOS RECÉM-CRIADOS
  ...
  // 1.4. PREPARAR DADOS DE FOTOS DE FUNCIONÁRIOS
  let indexFuncF = 0;
  let indexFuncM = 0;
  ...
  // 1.5. SEED DE FOTOS DE FUNCIONÁRIOS
  ...
  // ===============================================
  // 2. SEEDING DE ALUNOS E RELACIONAMENTOS
  // ===============================================
  ...
  // 2.2. BUSCAR IDs DOS ALUNOS RECÉM-CRIADOS
  ...
  // 2.3. PREPARAR DADOS DE FOTOS (101 Registros com URL)

  // URLS FEMININAS (ALUNAS)
  const urlsFemininas = [
    "https://i.ibb.co/5h3BnT92/mulher.png",
    // ... (todas as 55 URLs femininas de alunas) ...
  ...
  const urlsMasculinas = [
    ...
    // ... (todas as 46 URLs masculinas de alunos) ...
